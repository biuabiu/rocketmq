...
public class BrokerStartup {
	...
	public static BrokerController start(BrokerController controller) {
		try {
			...
			String tip = "The broker[" + controller.getBrokerConfig().getBrokerName() + ", " + controller.getBrokerAddr() + "] boot success. serializeType="
